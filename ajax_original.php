...
// ========== CUSTOMER PORTAL AJAX ACTIONS ==========

if($action == "update_document_status"){
	$save = $crud->update_document_status();
	if($save)
		echo $save;
}

if($action == "get_loan_review_details"){
	$save = $crud->get_loan_review_details();
	if($save)
		echo $save;
}

if($action == "update_loan_application_status"){
	$save = $crud->update_loan_application_status();
	if($save)
		echo $save;
}

if($action == "update_checklist_item"){
	$save = $crud->update_checklist_item();
	if($save)
		echo $save;
}
