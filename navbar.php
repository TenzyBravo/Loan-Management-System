...
<nav id="sidebar" class='mx-lt-5 bg-warning' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=customer_documents_admin" class="nav-item nav-customer_documents_admin"><span class='icon-field'><i class="fa fa-file-upload"></i></span> Customer Documents</a>
				<a href="index.php?page=loan_applications_review" class="nav-item nav-loan_applications_review"><span class='icon-field'><i class="fa fa-clipboard-check"></i></span> Loan Applications</a>
